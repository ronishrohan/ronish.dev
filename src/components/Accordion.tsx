  ...
  return (
    <div className="flex flex-col w-full h-fit">
      <button
        ...
        className={`hover:underline cursor-pointer relative flex justify-start transition-all duration-75 ${open && "italic font-bold"} hover:font-bold hover:text-white`}
      >
        <div className="absolute right-full mx-2 h-full size-2 flex items-center justify-center">
          ...
          <div
            ...
            className="h-[1px] w-full absolute duration-100 ease-in-out transition-all bg-white"
          ></div>
        </div>
        {title}
      </button>
